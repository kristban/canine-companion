    ...
    >
      ...
      >
        <div
          ...
          className="flex flex-col gap-6 rounded-3xl border border-border bg-surface p-6 shadow-sm sm:flex-row sm:items-center sm:p-8"
        >
          <div
            key={breed.id}
            aria-live="polite"
          ...
          >
            <div className="flex shrink-0 flex-col items-center text-center sm:w-40">
              ...
              <h3 className="mt-3 text-xl font-extrabold tracking-tight text-text">
                {breed.name}
              </h3>
        ...
        <button
          ...
          className="transition-smooth absolute left-0 top-1/2 hidden -translate-x-4 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-surface p-2 text-lg shadow-md hover:border-primary hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary sm:flex"
        >
          ←
        </button>
        <button
          ...
          className="transition-smooth absolute right-0 top-1/2 hidden translate-x-4 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-surface p-2 text-lg shadow-md hover:border-primary hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary sm:flex"
        >
          →
        </button>
      </div>
      ...
      <div className="mt-6 flex items-center justify-center gap-4">
        <button
          ...
          onClick={() => goTo(index - 1)}
          aria-label="Previous breed"
          className="transition-smooth flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-lg hover:border-primary hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary sm:hidden"
        >
          ←
        </button>
          ...
          {showcaseBreeds.map((b, i) => (
            <button
              ...
              className={`transition-smooth h-2.5 rounded-full ${
                i === index ? "w-6 bg-primary" : "w-2.5 bg-border hover:bg-secondary"
              }`}
            />
          ))}
        </div>
