...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <Link
      ...
      className="transition-smooth flex h-full flex-col gap-3 rounded-3xl border-3 border-border bg-surface p-6 shadow-hard hover:-translate-y-1 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
    >
      <span
